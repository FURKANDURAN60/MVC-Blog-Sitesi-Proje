...
namespace WebApplication1.Controllers
{
    public class MakaleController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var makale = db.Makaleler.Where(i => i.KullaniciAd == username).Select(i => new MakaleModel()
            {
                Id = i.Id,
                Baslik = i.Baslik,
        ...
        public ActionResult Create(Makale makale, HttpPostedFileBase File)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    return RedirectToAction("Index");  //Admin ise burası
                }
                else
                {
                    return View("Onay");
            ...
            ViewBag.KategoriId = new SelectList(db.Kategoriler, "Id", "KategoriAd", makale.KategoriId);
            return View(makale);
        }
